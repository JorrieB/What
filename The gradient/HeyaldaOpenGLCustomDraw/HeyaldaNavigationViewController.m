//
//  HeyaldaNavigationViewController.m
//  MXRagdollMasters
//
//  Created by Jim Range on 9/25/12.
...
@interface HeyaldaNavigationViewController ()

@end

@implementation HeyaldaNavigationViewController
...
{
   // NSLog(@"Called shouldAutorotate in nav controller.");
    return YES;
}
...
{
    //NSLog(@"Called supportedInterfaceOrientations in nav controller.");
...
{
   // NSLog(@"Called preferredInterfaceOrientationForPresentation in nav controller.");
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    ...
    //NSLog(@"Called shouldAutorotateToInterfaceOrientation in nav controller.");
    ...
    // NSLog(@"Rotating");
 //   return [[HeyaldaGameManager gameManager] shouldAutorotateToInterfaceOrientation:interfaceOrientation];
